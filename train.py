...
def parse_args():
    ...
    parser.add_argument("--train_data_path", type=str, default="/home1/asd/tmp/DIV2K_train.h5")
    parser.add_argument("--valid_data_path", type=str, default="/home1/asd/tmp/OverNet-PyTorch_10/Set5/image_SRF_4")
